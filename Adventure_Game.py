...
shop_items = ["Health Portion (Health)             - Worth 50$",
              "Robes of Freya (Freya)             - Worth 300$",
              "Dress of a princess (Princess)     - Worth 500$",
              "Glittering steel armour (Armour)   - Worth 400$",
              "A grand Tribute  (Tribute)       - Not for sale",
              "A Talisman (Talisman)              - Worth 300$",
              "Jewellary (Jewellary)              - Worth 400$",
              "Durandal,a mighty sword (Durandal) - Worth 600$",
              "Steel Helmet (Helmet)              - Worth 200$",
              "Go back to village (Village)     - None      "]
...
def village():
    ...
    print_pause("NOTE: Type the name, not the number")
    ...
    elif str.lower("fort") in village_choice:
        fort()
    # if player decides to enter into the secret passage
    elif str.lower("secret") in village_choice and "Secret Passage" in village_locations:
        secret_passage()
...
def shop():
    ...
    if str.lower("health") in shop_choice:
    ...
    elif str.lower("freya") in shop_choice and freya_dress == "available":
        if gold >= 300:
    ...
    # player cannot buy this item, if the item is already sold out
    elif str.lower("princess") in shop_choice and princess_dress == "available":
        if gold >= 500:
    ...
    # player cannot buy this item, if the item is already sold out
    elif str.lower("Armour") in shop_choice and armour == "available":
        if gold >= 400:
    ...
    elif str.lower("Talisman") in shop_choice:
        if gold >= 300:
    ...
    elif str.lower("Jewellary") in shop_choice:
        if gold >= 400:
    ...
    # player cannot buy this item, if the item is already sold out
    elif str.lower("Durandal") in shop_choice and durandal == "available":
    ...
    # player cannot buy this item, if the item is already sold out
    elif str.lower("Tribute") in shop_choice and tribute == "available":
    ...
    # player cannot buy this item, if the item is already sold out
    elif str.lower("Steel Helmet") in shop_choice and helmet == "available":
        if gold >= 200:
    ...
    elif str.lower("Village") in shop_choice:
        print_pause("You head back to the village (Village)")
        village()
...
def forest_explore():
    ...
    print("NOTE: The forest is vast")
    forest_explore_action = int(input("Enter the number of the location, you want to search: "))
